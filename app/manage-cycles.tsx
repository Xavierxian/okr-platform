...
const styles = StyleSheet.create({
  ...
  orderBadge: { width: 28, height: 28, borderRadius: 14, backgroundColor: Colors.primary + '15', alignItems: 'center', justifyContent: 'center' },
  orderText: { fontFamily: 'Inter_600SemiBold', fontSize: 12, color: Colors.primary },
  cycleName: { fontFamily: 'Inter_500Medium', fontSize: 15, color: Colors.text, flex: 1 },
  iconBtn: { width: 36, height: 36, borderRadius: 8, alignItems: 'center', justifyContent: 'center' },
  addCard: { marginHorizontal: 20, backgroundColor: Colors.backgroundTertiary, borderRadius: 12, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: Colors.primary + '30' },
  addTitle: { fontFamily: 'Inter_600SemiBold', fontSize: 15, color: Colors.text, marginBottom: 10 },
  editContainer: { gap: 10 },
  editRow: { flexDirection: 'row', gap: 8 },
  editInput: { backgroundColor: Colors.background, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 10, fontSize: 15, fontFamily: 'Inter_400Regular', color: Colors.text },
  editActions: { flexDirection: 'row', gap: 8 },
  saveBtn: { backgroundColor: Colors.primary, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 8 },
  saveBtnText: { fontFamily: 'Inter_500Medium', fontSize: 13, color: Colors.white },
  cancelBtn: { backgroundColor: Colors.backgroundTertiary, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 8, borderWidth: 1, borderColor: Colors.border },
  cancelBtnText: { fontFamily: 'Inter_500Medium', fontSize: 13, color: Colors.textSecondary },

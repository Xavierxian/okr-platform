...
const styles = StyleSheet.create({
  ...
  userChip: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 12, paddingVertical: 8, borderRadius: 10, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#EBEEF5' },
  userChipActive: { backgroundColor: '#0082EF', borderColor: '#0082EF' },
  collabChipActive: { backgroundColor: '#0082EF', borderColor: '#0082EF' },
  userChipText: { fontFamily: 'Inter_500Medium', fontSize: 13, color: '#5E6D82' },
  userChipTextActive: { color: '#FFFFFF' },
  collabChipTextActive: { color: '#FFFFFF' },
  ...
  emptyHint: { fontFamily: 'Inter_400Regular', fontSize: 13, color: '#8F9BB3', paddingVertical: 8 },
  retryRow: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingVertical: 10 },
  retryText: { fontFamily: 'Inter_400Regular', fontSize: 13, color: '#FF4D4F' },
  typeChip: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 10, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#EBEEF5' },
  typeChipActive: { backgroundColor: '#0082EF', borderColor: '#0082EF' },
  typeChipText: { fontFamily: 'Inter_500Medium', fontSize: 13, color: '#5E6D82' },
